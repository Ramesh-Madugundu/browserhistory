...
class App extends Component {
  ...
  FillFunction = value => {
    ...
    const newHistoryList = latestHistoryList.filter(eachValue => eachValue.id ===! value,)
  ...
  ChangeFunction = e =>{this.setState({searchInput:e.target.value})
  } 
